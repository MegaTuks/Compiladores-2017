...
Blockly.Blocks['declare_var'] = {
  init: function() {
    this.appendValueInput("variables")
        .setCheck(null)
        .appendField(new Blockly.FieldDropdown([["entero", "entero"], ["caracter", "caracter"], ["real", "real"], ["booleano", "booleano"]]), "varType")
        .appendField(new Blockly.FieldTextInput("nomVar"), "NAME")
        .appendField("=");
...
Blockly.Blocks['varis_item'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldTextInput("variable"), "item");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(65);
    this.setTooltip('');
